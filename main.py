...
CONNECTION_STRING = "DefaultEndpointsProtocol=https;AccountName=diocursobootcamp;AccountKey=IV4D/Eb1Htw/XTDhMsBs/ynfTy1efut7DAwUF8zJGNoha174tTCKSuk2AZ82rMMD5yC6AWRTmlKm+ASttHKUOg==;EndpointSuffix=core.windows.net"
CONTAINER_NAME = "fotos"
ACCOUNT_NAME = "diocursobootcamp"

# Configurações do Azure SQL Server
SQL_SERVER   = "bdreceba.database.windows.net"
SQL_DATABASE = "bdDio"
SQL_USERNAME = "serginhomalandroamoaalice24barra7"
SQL_PASSWORD = "vaiRecebendo24horapordia"
